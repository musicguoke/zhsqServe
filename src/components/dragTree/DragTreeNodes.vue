<template>
  <ol drag-tree-nodes v-if="isShow" class="drag-tree-nodes" :class="{hidden: collapsed}">
    <drag-tree-node 
      v-for="li in list"
      :key="li.name"
      :nodeData="li"
    ...
    <li class="drag-tree-node drag-tree-placeholder" v-else-if="li.placeholder" :style="{height: `${nodeHeight}px`}">
    </li>
  </ol>
</template>
<script>
