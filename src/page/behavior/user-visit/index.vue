    ...
    <div id="service-analysis">
                ...
                <li class="date-box">
                    ...
                    <div class="block">
                      <DatePicker 
                        ...
                        placeholder="请选择开始结束时间"
                        style="width: 200px"
                        @on-change="getSysVersionDateData"></DatePicker>
                    </div>
                </li>
            </ul>
                ...
                <li class="date-box">
                    ...
                    <div class="block">
                      <DatePicker 
                        ...
                        placeholder="请选择开始结束时间"
                        style="width: 200px"
                        @on-change="getSoftVersionDateData"></DatePicker>
                    </div>
                </li>
            </ul>
         ...
         <div class="main">
            ...
            <table border="1" style="table-layout: fixed;">
                <thead>
                    <tr v-if="data.length > 0" class="three">
                        ...
                        <th v-if="type == 4">系统版本<i class="icon-sort"></i></th>
                        <th v-else-if="type == 5">软件版本<i class="icon-sort"></i></th>
                        <th v-if="type == 1 || type == 2 && departmentObj == null">部门名称<i class="icon-sort"></i></th>
                        <th v-if="type == 2">用户名<i class="icon-sort"></i></th>
                        <th v-if="type == 2 && departmentObj !== null">部门<i class="icon-sort"></i></th>
                        <th v-if="type == 2 && dataObj !== null">软件版本<i class="icon-sort"></i></th>
                        <th v-else-if="type == 2 && dataObj !== null">系统版本<i class="icon-sort"></i></th>
                        <th v-if="type == 3 && userObj !== null">用户名<i class="icon-sort"></i></th>
                        <th v-if="type == 3 && userObj !== null">数据名称<i class="icon-sort"></i></th>
                    ...
                    <tr v-else>
                        ...
                        <th v-if="type == 1">数据名称<i class="icon-sort"></i></th>
                        <th>访问方式<i class="icon-sort"></i></th>
                        <th v-if="type == 2">系统版本<i class="icon-sort"></i></th>
                        <th v-if="type == 2">软件版本<i class="icon-sort"></i></th>
                        <th>所在部门<i class="icon-sort"></i></th>
                ...
                <tbody>
                    <tr v-for="(item, index) in data">
                        ...
                        <td v-if="type == 2 && departmentObj !== null">{{departmentObj.name}}<i class="icon-sort"></i></td>
                        <td v-if="type == 2 && dataObj !== null && dataObj.softVersion">{{dataObj.softVersion}}<i class="icon-sort"></i></td>
                        <td v-else-if="type == 2 && dataObj !== null && dataObj.sysVersion">{{dataObj.sysVersion}}<i class="icon-sort"></i></td>
                        <td v-if="type == 3 && userObj !== null">{{userObj.name}}<i class="icon-sort"></i></td>
                        <td v-if="type == 3 && userObj !== null">{{item.name}}<i class="icon-sort"></i></td>
            ...
            <div class="block pagination">
              <Page
                v-if="config.search && !config.userId"
                :total="total"
              ...
              ></Page>
              <Page
                v-else-if="config.sysVersion"
                :total="total"
                :current.sync="currentPage"
                @on-change="handleSysVersion"
              ></Page>
              <Page
                v-else-if="config.softVersion"
                :total="total"
                :current.sync="currentPage"
                @on-change="handleSoftVersion"
              ></Page>
              <Page
                v-else
                :total="total"
