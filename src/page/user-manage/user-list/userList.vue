        ...
        <Card :style="{maxHeight:userListHeight}">
            ...
            <div class="tableSize">
                <el-table :data="userData" border style="width: 100%" @filter-change="filterChange">
                    ...
                    <el-table-column prop="areaname" label="区县"  :filters="countyFilterList"  column-key="filterByAreaName">
                    </el-table-column>
  ...
  methods: {
    ...
    userEditOpen(params) {
      ...
      this.$refs.department1.values = [
        { value: this.userForm.arBranch, label: this.userForm.name }
      ];
