...
const SyntheticalPeriphery = r =>
  require([
    "@/page/resource/search-manage/search-item/syntheticalPeriphery"
  ], r);
const PlanPeriphery = r =>
...
//地图
const mapController = r => {
  require(["@/page/mapBox/map"], r);
};
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          meta: { title: "搜索管理" },
          redirect: { name: "SyntheticalPeriphery" },
          children: [
            {
              path: "synthetical-periphery",
              component: SyntheticalPeriphery,
              name: "SyntheticalPeriphery",
              meta: { title: "综合周边" }
            },
            {
              path: "hot-search",
